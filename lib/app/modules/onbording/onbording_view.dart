                    ...
                    children: [
                      InkWell(
                        ...
                        child: Padding(
                          ...
                          child: SvgPicture.asset("assets/icons/back_button_icon.svg"),
                        ),
                      ),
                      SizedBox(width: 10,),
                      InkWell(
                        ...
                        onTap: _currentPage < pages.length - 1
                            ...
                            : null,
                        child: SvgPicture.asset("assets/icons/forword_button_icon.svg"),
                      ),
                    ],
                  )
                ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      description,
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff717171),height: 1.6),
                    ),
                  ],
                ),
              ),
